...
public class Ones_Matrix extends Matrix{

    public Ones_Matrix(int[][] matrix, int rows, int columns) {
        ...
        if (this.getRows() == matrix1.getRows() && this.getColumns() == matrix1.getColumns()) {
            for (int i = 0; i < this.getRows(); i++) {
                for (int j = 0; j < this.getColumns(); j++) {
                    System.out.print(matrix1.getMatrix()[i][j]+1+" ");
                }
                System.out.println();
            }
        } else {
    ...
    public void Subtraction(Matrix matrix1) {
        if (this.getRows() == matrix1.getRows() && this.getColumns() == matrix1.getColumns()) {
            for (int i = 0; i < this.getRows(); i++) {
                for (int j = 0; j < this.getColumns(); j++) {
                    System.out.print(1-matrix1.getMatrix()[i][j]+" ");
                }
                System.out.println();
            }
        } else {
